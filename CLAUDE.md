...
писмо; `crm_staff.notify_email` за отписване; RLS: само admin)
...
118 теста (`npm test`, vitest) — чиста логика: `contract`, `utils`, `trz`,
`tableIndices`, `subscriptionBuckets`, `monitoring`, `notifications`. НЯМА тестове на компоненти
