...
169 теста (`npm test`, vitest) — чиста логика: `contract`, `utils`, `trz`,
...
първа част от пътеката; менюто и футърът имат кратък текст. Печели
най-многолюдната група. При това четене има заглавие и линк, но НЯМА
резюме и дата.
