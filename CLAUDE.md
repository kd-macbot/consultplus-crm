...
1. RLS на финансови таблици — `using(true)` за всички логнати. РЕШЕНО да
   остане така (07.2026): банковите данни са само за вход/справка, колегите
   нямат права за плащания → съзнателно приет риск. НЕ предлагай стягане,
   освен ако потребителят сам не го повдигне.
